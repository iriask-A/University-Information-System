...
import kbtu.model.notification.Request;

import java.util.ArrayList;
import java.util.List;

/**
 * A technical support employee who handles user requests.
 */
public class TechSupportSpecialist extends Employee {
    ...
    public void acceptRequest(Request r) {
        ...
        if (!activeRequests.contains(r)) activeRequests.add(r);
    }
    ...
    public List<Request> getActiveRequests() { return activeRequests; }
}
